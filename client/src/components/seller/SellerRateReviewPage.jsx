...
import styles from "./SellerRateReviewPage.module.css";
import useAuth from "../../hooks/useAuth";
import axios from "../../api/axios";

const SellerRateReviewPage = () => {
	...
	const handleGoBack = () => {
		navigate(`/seller/listings`); // Go back to the previous page
	};
...
export default SellerRateReviewPage;
