...
def createUserProfile():
    ...
    try:
        ...
        if(isCreated):
            return jsonify({"status": "success", "message": "User profile successfully created"}), 201
    except Exception as e:
        return jsonify({"status": "error", "message": "User profile cannot be created.", "error message": str(e)}), 500
