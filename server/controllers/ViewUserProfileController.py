...
def getUserProfiles():
    ...
    if(user_profiles is None):
        return jsonify({"status": "error", "message": "No user profile found", "user_profiles": None}), 404
    else:
        return jsonify({"status": "success", "message": "User profiles found!", "user_profiles": user_profiles}), 200
...
def getUserProfile(profile_name):
    ...
    if(user_profile is None):
        ...
        return jsonify({"status": "success", "message": "User profile found!", "user_profile": user_profile}), 200